...
const CHANNELS = [
  { Icon: Bell, tint: '#5b51e8', label: 'Push Notifications', value: '720', pct: '39.1%', bar: 100, color: '#5b51e8' },
  { Icon: Send, tint: '#2e90fa', label: 'SMS', value: '612', pct: '33.2%', bar: 85, color: '#2e90fa' },
  { Icon: FileText, tint: '#16a34a', label: 'Email', value: '360', pct: '19.5%', bar: 50, color: '#16a34a' },
  { Icon: BellRing, tint: '#f59e0b', label: 'In-App', value: '150', pct: '8.2%', bar: 21, color: '#f59e0b' },
]
        ...
        <Card>
          ...
          <div className="pager">
            ...
            <div className="pager-mid">
              ...
              <span className="pgbtn dots">…</span>
              <button className="pgbtn">185</button>
              <button className="pgbtn">›</button>
            </div>
            <div className="pgsize"><select className="select"><option>10 / page</option></select></div>
          </div>
        </Card>
