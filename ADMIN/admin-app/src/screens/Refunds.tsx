...
const csvRow = (r: Refund) => [r.ref, r.ref, r.customer, r.total, r.refund ?? '', r.payment ?? '', r.cancel_reason ?? '', r.payment_status ?? '', r.created]
  ...
  return (
    <div className="grid" style={{ gap: 16 }}>
      <div className="stat-row">
        ...
        <StatCard icon={<Wallet size={22} />} tint="#2e90fa" label="Refunds This Month" value={money(totalRefunds)} sub="Monthly Total" />
      </div>
