...
# Auto-detects your current Wi-Fi LAN IP, points the app at <ip>:8080, and assembles the APK.
...
Write-Host "App points to http://$ip`:8080 - make sure the backend is running (the microservices stack (docker compose -f infra/docker-compose.yml up))." -ForegroundColor Yellow
