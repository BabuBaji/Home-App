...
export default function WorkerDetail() {
  ...
  const skillsServicesTab = !ss ? <div className="muted" style={{ fontSize: 13, padding: '18px 0' }}>Skills data unavailable.</div> : (() => {
    ...
    const row3: CSSProperties = { display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(0,1.5fr) minmax(0,1fr)', gap: 0, alignItems: 'start' }
    // Row 2 gives the wide history table more room and keeps the compact Skill Summary narrow.
    const row3b: CSSProperties = { display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(0,1.8fr) minmax(0,0.7fr)', gap: 0, alignItems: 'start' }
    ...
    return (
      <div className="tab-dense grid" style={{ gap: 0 }}>
